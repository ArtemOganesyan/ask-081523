...
Feature: Functional tests for AS
...
Scenario Outline: Successful register new user
  ...
  Scenario Outline: Empty field
    ...
    Then I click on element with xpath "//button[@type='submit']"
    And I wait for element with xpath "//*[contains(text(), 'This field is required')]/../.." to be present
    And element with xpath "//*[contains(text(), 'This filed is required')]/../.." should be displayed
